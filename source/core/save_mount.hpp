...
/// here, takes an explicit id (never a "current title" implicit), logs its
/// Result, and is the ONE thing in this change that could not be verified against
/// a real libnx header in the sandbox — see the note at the call site.
