...
//
// Dump reuses Core::Dump::dump_title_to_nsp() unchanged - nothing about dumping
// is card-specific. INSTALL is not here yet: copying cartridge content into
// SD/NAND is scoped in the roadmap, deliberately not bolted on.
