...
> **Status:** Moderate progress. Milestone 5 (NSP/NSZ/XCI/XCZ installation logic) is complete and builds. See [Roadmap](#roadmap).
...
A PC stub target exists for rapid UI iteration without hardware:
...
I have not used the PC stub as of yet, so treat it as POC for now. The NRO generated by the build is small enough that testing on the actual hardware has been simple and hassle free.
