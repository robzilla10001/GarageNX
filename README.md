...
GarageNX is my first foray into Switch homebrew. It stands on the shoulders of the broader Switch homebrew community's documentation and reverse-engineering work. For a full list of bundled/linked projects, please see /docs/THIRD_PARTY.md
...
- /docs/THIRD_PARTY.md is a more complete list of acknowledgements. 
