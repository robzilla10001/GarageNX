...
- **Code** - bug fixes, new features, refactoring toward the architecture in `docs/ARCHITECTURE.md`.
...
Read `docs/ARCHITECTURE.md`. It captures the module layout, the invariants that hold the codebase together, and the design decisions. Structural changes should be discussed against that document first - open an issue before a large PR.
